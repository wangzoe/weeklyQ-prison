...
def prison_delima(n, strategy1, strategy2):
    ...
    while n > 0:
        if strategy1=="nice" and strategy2=='nice':
            ...
            suspect2 += 0
            n -= 1
        elif strategy1=='nice' and strategy2=='tit_for_tat':
            suspect1 += 1
            suspect2 += 1
            strategy2 = 'nice'
            n -= 1
            ...
            suspect2 += 2
            n -= 1
        elif strategy1=='rat' and strategy2=='tit_for_tat':
            suspect1 += 0
            suspect2 += 5
            strategy2 = 'rat'
            n -= 1
        elif strategy1=='tit_for_tat' and strategy2=='nice':
            suspect1 += 1
            suspect2 += 1
            strategy1 = 'nice'
            n -= 1
        elif strategy1=='tit_for_tat' and strategy2=='rat':
            suspect1 += 5
            suspect2 += 0
            strategy1 = 'rat'
            n -=1
...
def expectation_of_certen_type(certen_type, n, times=100):
    types = ['nice', 'rat', 'tit_for_tat']
    years_for_certen=[]
    years_for_random=[]
    years=[]
